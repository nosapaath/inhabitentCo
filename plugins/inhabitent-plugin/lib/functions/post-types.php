...
function products_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Upload products to sell in inhabitent', 'text_domain' ),
		'labels'                => $labels,
...
function adventure_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Upload Cool Adventures', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'author', 'editor', 'thumbnail', 'comments', 'custom-fields' ),
		'taxonomies'            => array(),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
