 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Business Widget
 * Plugin URI:        https://github.com/nosapaath/inhabitentCo
 * Description:       Contact Us and Business Hours
 * Version:           1.0.0
 * Author:            Nosa
...
class Business_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'business-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Insert your Business Info here'
			)
		);
...
add_action( 'widgets_init', function(){
    register_widget( 'Business_Widget' );
});
